...
- Release run: install `target/release/bundle/nsis/T4 Git UI_<version>_x64-setup.exe`
...
- [x] Launch with no previous repo → start screen: header `T4 Git UI 0.10.11`, `RECENT` column,
