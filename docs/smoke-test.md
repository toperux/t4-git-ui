...
- Release run: install `target/release/bundle/nsis/t4-git-ui_0.5.0_x64-setup.exe`
...
- [x] Launch with no previous repo → start screen: header `T4 Git 0.5.0`, `RECENT` column,
